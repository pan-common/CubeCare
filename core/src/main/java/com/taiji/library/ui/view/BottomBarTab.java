...
public class BottomBarTab extends FrameLayout{
    ...
    public BottomBarTab(Context context, @DrawableRes int iconRes,@StringRes int textRes) {
        this(context, null, iconRes,textRes);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int icon,int textRes) {
        this(context, attrs, 0, icon,textRes);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int defStyleAttr, int icon,int textRes) {
        super(context, attrs, defStyleAttr);
        init(context, icon,textRes);
    }

    private void init(Context context, int icon,int textRes) {
        mContext = context;
